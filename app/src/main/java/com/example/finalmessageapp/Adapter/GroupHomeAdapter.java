...
public class GroupHomeAdapter extends RecyclerView.Adapter<GroupHomeAdapter.MyViewHolder> {
    ...
    public GroupHomeAdapter(ArrayList<GroupModels> groupModelsArrayList, Context context, GroupAddMemberListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.grouphomeitem,parent,false));
    }
